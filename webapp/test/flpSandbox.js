		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sense and Stock",
									"targetURL": "#SenseandStock-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SenseandStock-display": {
								"semanticObject": "SenseandStock",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ts.zrefill",
									"url": sap.ui.require.toUrl("ts/zrefill")
								}
							}
						}
					}
